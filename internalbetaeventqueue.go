...
type InternalBetaEventQueueUpdateParams struct {
	...
	// "REPLAY_WEBHOOK_EVENT", "SUBSCRIPTIONS_MIGRATED",
	// "SUBSCRIPTIONS_MIGRATION_TRIGGERED", "SUBSCRIPTION_BILLING_MONTH_ENDS_SOON",
	// "SUBSCRIPTION_USAGE_CHARGE_TRIGGERED", "SCHEDULER_BATCH", "EVENT_LOG_CREATED",
	// "CREDIT_GRANT_CREATED", "CREDIT_GRANT_EXPIRED", "CREDIT_GRANT_VOIDED",
	// "CREDIT_GRANT_UPDATED", "CREDIT_GRANT_DEPLETED", "CREDIT_GRANT_BALANCE_LOW",
	// "CREDIT_BALANCE_UPDATED", "CREDIT_BALANCE_DEPLETED", "CREDIT_BALANCE_LOW",
