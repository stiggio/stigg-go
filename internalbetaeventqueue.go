...
type InternalBetaEventQueueUpdateParams struct {
	...
	// "INCOMING_DOGGO_WEBHOOK", "INCOMING_APP_STORE_WEBHOOK",
	// "INCOMING_AIRBYTE_WEBHOOK", "RESYNC_INTEGRATION", "SYNC_COUPON",
	// "IMPORT_INTEGRATION_CATALOG", "IMPORT_INTEGRATION_CUSTOMERS", "SYNC_FAILED",
	// "DATA_EXPORT_SYNC_FAILED", "CUSTOMER_PAYMENT_FAILED", "PRODUCT_CREATED",
	// "PRODUCT_UPDATED", "PRODUCT_DELETED", "PRODUCT_UNARCHIVED",
	// "PACKAGE_GROUP_CREATED", "PACKAGE_GROUP_UPDATED", "ENVIRONMENT_DELETED",
	// "WIDGET_CONFIGURATION_UPDATED", "EDGE_API_DATA_RESYNC", "EDGE_API_DOGGO_RESYNC",
