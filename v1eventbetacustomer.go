...
type V1EventBetaCustomerService struct {
	...
	Entities     V1EventBetaCustomerEntityService
	Assignments  V1EventBetaCustomerAssignmentService
}
...
func NewV1EventBetaCustomerService(opts ...option.RequestOption) (r V1EventBetaCustomerService) {
	...
	r.Entities = NewV1EventBetaCustomerEntityService(opts...)
	r.Assignments = NewV1EventBetaCustomerAssignmentService(opts...)
	return
}
