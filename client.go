...
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("STIGG_BASE_URL"); ok {
		defaults = append(defaults, option.WithBaseURL(o))
	}
	if o, ok := os.LookupEnv("STIGG_API_KEY"); ok {
		defaults = append(defaults, option.WithAPIKey(o))
	}
	if o, ok := os.LookupEnv("STIGG_CUSTOM_HEADERS"); ok {
...
// environment (STIGG_API_KEY, STIGG_BASE_URL). The option passed in as arguments
...
func NewClient(opts ...option.RequestOption) (r Client) {
	...
	r.V1Beta = NewV1BetaService(opts...)
