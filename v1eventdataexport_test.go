...
func TestV1EventDataExportListModelsWithOptionalParams(t *testing.T) {
	...
	_, err := client.V1.Events.DataExport.ListModels(context.TODO(), stigg.V1EventDataExportListModelsParams{
