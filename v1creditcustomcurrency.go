...
// Response object
type CustomCurrencyResponse struct {
	// A custom currency used to denominate credit-based entitlements and pricing
	Data CustomCurrencyResponseData `json:"data" api:"required"`
...
func (r CustomCurrencyResponse) RawJSON() string { return r.JSON.raw }
func (r *CustomCurrencyResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// A custom currency used to denominate credit-based entitlements and pricing
type CustomCurrencyResponseData struct {
	...
	Units CustomCurrencyResponseDataUnits `json:"units" api:"required"`
...
// Returns the unmodified JSON received from the API
func (r CustomCurrencyResponseData) RawJSON() string { return r.JSON.raw }
func (r *CustomCurrencyResponseData) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// Singular and plural unit labels for a custom currency
type CustomCurrencyResponseDataUnits struct {
...
// Returns the unmodified JSON received from the API
func (r CustomCurrencyResponseDataUnits) RawJSON() string { return r.JSON.raw }
func (r *CustomCurrencyResponseDataUnits) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
