...
```go
import (
	"github.com/stiggio/stigg-go" // imported as stigg
)
```
...
```sh
go get -u 'github.com/stiggio/stigg-go@v0.1.0-alpha.10'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/stiggio/stigg-go/option).
