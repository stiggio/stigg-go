...
func (r *V1PlanService) ListCharges(ctx context.Context, id string, query V1PlanListChargesParams, opts ...option.RequestOption) (res *pagination.MyCursorIDPage[ChargeListData], err error) {
	var raw *http.Response
	opts = slices.Concat(r.Options, opts)
	opts = append([]option.RequestOption{option.WithResponseInto(&raw)}, opts...)
	if id == "" {
...
// Retrieves the list of charges configured on a plan.
func (r *V1PlanService) ListChargesAutoPaging(ctx context.Context, id string, query V1PlanListChargesParams, opts ...option.RequestOption) *pagination.MyCursorIDPageAutoPager[ChargeListData] {
...
func (r *V1PlanService) ListOverageCharges(ctx context.Context, id string, query V1PlanListOverageChargesParams, opts ...option.RequestOption) (res *pagination.MyCursorIDPage[ChargeListData], err error) {
	var raw *http.Response
	opts = slices.Concat(r.Options, opts)
	opts = append([]option.RequestOption{option.WithResponseInto(&raw)}, opts...)
	if id == "" {
...
// Retrieves the list of overage charges configured on a plan.
func (r *V1PlanService) ListOverageChargesAutoPaging(ctx context.Context, id string, query V1PlanListOverageChargesParams, opts ...option.RequestOption) *pagination.MyCursorIDPageAutoPager[ChargeListData] {
